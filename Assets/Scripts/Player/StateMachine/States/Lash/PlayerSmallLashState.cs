...
public class PlayerSmallLashState : PlayerBaseState
{
    public PlayerSmallLashState(PlayerStateMachine currentCtx, PlayerStateFactory stateFactory) : base(currentCtx, stateFactory) { }
