...
public class PlayerFullLashState : PlayerBaseState
{
    public PlayerFullLashState(PlayerStateMachine currentCtx, PlayerStateFactory stateFactory) : base(currentCtx, stateFactory) { }
